// src/store/actions/adminActions.ts
...
>(
  ...
  async (params, { rejectWithValue }) => {
    try {
      ...
      // keep role + status like your previous version
      if (params.role !== undefined) queryParams.append("role", String(params.role));
...
>(
  ...
  async (data, { rejectWithValue }) => {
    try {
      const response = await apiClient.post<Admin, AdminFormData>(
