...
const Dashboard: React.FC = () => {
  ...
  const { projects, total: totalProjects } = useSelector(
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl border border-blue-200 p-6 shadow-sm hover:shadow-md transition-shadow">
          ...
          <p className="text-xs text-gray-500 mt-2">Across all statuses</p>
        </div>
            ...
            <div>
              ...
              <div className="w-full bg-gray-200 rounded-full h-3">
                <div
                  ...
                  style={{
                    width: `${totalProjects > 0 ? (activeProjects / totalProjects) * 100 : 0}%`,
                  }}
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="w-full bg-gray-200 rounded-full h-3">
                <div
                  ...
                  style={{
                    width: `${totalProjects > 0 ? (onHoldProjects / totalProjects) * 100 : 0}%`,
                  }}
                />
              </div>
            </div>
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between p-4 bg-gradient-to-r from-blue-50 to-blue-100 rounded-lg border border-blue-200">
              ...
              <span className="text-2xl font-bold text-blue-600">
                {roleDistribution.hr + roleDistribution.pm}
              </span>
            </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          <div className="text-center p-4 bg-gray-50 rounded-lg">
            ...
            <p className="text-2xl font-bold text-gray-900">
              {totalProjects > 0
                ? Math.round(totalProjects / totalProjects)
                : 0}
            </p>
          </div>
          <div className="text-center p-4 bg-gray-50 rounded-lg">
            ...
            <p className="text-2xl font-bold text-gray-900">
              {roleDistribution.hr > 0
                ? Math.round(totalProjects / roleDistribution.hr)
                : totalProjects}
            </p>
          </div>
          <div className="text-center p-4 bg-gray-50 rounded-lg">
